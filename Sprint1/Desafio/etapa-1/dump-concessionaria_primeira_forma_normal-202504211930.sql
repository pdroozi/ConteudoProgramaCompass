...
--
-- Host: localhost    Database: concessionaria_primeira_forma_normal
-- ------------------------------------------------------
...
CREATE TABLE `tb_locacao` (
  ...
  CONSTRAINT `tb_locacao_ibfk_3` FOREIGN KEY (`id_Combustivel`) REFERENCES `tb_combustivel` (`id_Combustivel`),
  CONSTRAINT `tb_locacao_ibfk_4` FOREIGN KEY (`id_Vendedor`) REFERENCES `tb_vendedor` (`id_Vendedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'concessionaria_primeira_forma_normal'
--
...
-- Dump completed on 2025-04-21 19:30:46
