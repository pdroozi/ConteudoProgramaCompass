...
s3_client.upload_file('data/movies.csv', bucket_name, f'Raw/Local/CSV/Movies/2025/06/09/movies.csv')
print("Arquivo movies.csv enviado com sucesso!")

s3_client.upload_file('data/series.csv', bucket_name, f'Raw/Local/CSV/Series/2025/06/09/series.csv')
